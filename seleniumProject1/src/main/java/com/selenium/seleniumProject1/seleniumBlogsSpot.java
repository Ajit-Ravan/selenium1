...
public class seleniumBlogsSpot {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement redCheckbox = driver
				.findElement(By.xpath("//*[@id=\"post-body-7702345506409447484\"]/div/input[1]"));
		...
		WebElement InternetEx = driver
				.findElement(By.xpath("//*[@id=\"post-body-7702345506409447484\"]/div/div/input[1]"));
